Shader "My Shaders/beguiner/gloss and emit map"
{
	Properties
	{
	...
	SubShader
	{
		Pass
		{
			...
			float4 frag(vertexOutput i) : COLOR
			{
				...
				float4 emitTex = tex2D(_EmitMap, i.tex.xy * _EmitMap_ST.xy + _EmitMap_ST.zw);
				...
				float3 lightFinal = UNITY_LIGHTMODEL_AMBIENT.xyz + diffuseReflection + (specularReflection * tex.a) + rimLighting + (emitTex.xyz * _EmitStrength);
